...
class WindowsMemory(MemoryType):
    ...
    def enable_anticheat(self) -> None:
        ...
        self.write_bytes(
            Buffer[
                0xC7, 0x87, 0xE0, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xC7, 0x87, 0xE4,
    ...
    def disable_anticheat(self) -> None:
        ...
        self.write_bytes(
            Buffer[
                0x80, 0xBF, 0xDD, 0x02, 0x00, 0x00, 0x00, 0x0F, 0x85, 0x0A, 0xFE, 0xFF, 0xFF,
                0x80, 0xBF, 0x34, 0x05, 0x00, 0x00, 0x00, 0x0F, 0x84, 0xFD, 0xFD, 0xFF, 0xFF
            ], 0x1FD742
        )
