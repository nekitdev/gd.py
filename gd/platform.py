...
if SYSTEM_PLATFORM_STRING.startswith(DARWIN_LITERAL):
    DARWIN = True

if SYSTEM_PLATFORM_STRING.startswith((LINUX_LITERAL, FREE_BSD_LITERAL)):
    LINUX = True

if SYSTEM_PLATFORM_STRING.startswith(ANDROID_LITERAL):
    ANDROID = True
