...
class ArtistAPISchema:
    ...
    def from_bytes(
        ...
        traversal_limit_in_words: Optional[int] = ...,
        nesting_limit: Optional[int] = ...,
    ) -> ContextManager[ArtistAPIReader]: ...
    @classmethod
    def from_bytes_packed(
        cls,
        data: bytes,
    ...
    @classmethod
    def read(cls, reader: BufferedReader) -> ArtistAPIReader: ...
    @classmethod
    def read_packed(cls, reader: BufferedReader) -> ArtistAPIReader: ...
    @classmethod
...
class ArtistAPIBuilder:
    ...
    def copy(self) -> ArtistAPIBuilder: ...
    def to_bytes(self) -> bytes: ...
    def to_bytes_packed(self) -> bytes: ...
    def as_reader(self) -> ArtistAPIReader: ...
    def write(self, writer: BufferedWriter) -> None: ...
    def write_packed(self, writer: BufferedWriter) -> None: ...
